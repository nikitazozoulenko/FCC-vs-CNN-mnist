...
if __name__ == "__main__":
    ...
    grapher.graph([train_losses[0][0], train_losses[1][0],  val_losses[0][0], val_losses[1][0]],
                  [train_losses[0][1], train_losses[1][1],  val_losses[0][1], val_losses[1][1]],
                  ["r", "g", "r--", "g--"],
                  ["CNN Training Loss", "FCC Training Loss","CNN Validation Loss", "FCC Validation Loss"],
                  "Loss", "Iterations",
                  list_ewmas = [0.99, 0.99, 0.9, 0.9])

    grapher.graph([val_acc[0][0], val_acc[1][0]],
                  [val_acc[0][1], val_acc[1][1]],
                  ["r--", "g--", "b--"],
                  ["CNN Validation Accuracy", "FCC Validation Accuracy"],
                  "Accuracy", "Iterations",
                  list_ewmas = [0.9, 0.9])

    grapher.graph([test_losses[0][0], test_losses[1][0]],
                  [test_losses[0][1], test_losses[1][1]],
                  ["r", "g", "b"],
                  ["CNN Test Loss", "FCC Test Loss"],
                  "Loss", "Iterations",
                  list_ewmas = [0, 0])

    grapher.graph([test_acc[0][0], test_acc[1][0]],
                  [test_acc[0][1], test_acc[1][1]],
                  ["r", "g", "b"],
                  ["CNN Test Accuracy", "FCC Test Accuracy"],
                  "Accuracy", "Iterations",
                  list_ewmas = [0, 0])
